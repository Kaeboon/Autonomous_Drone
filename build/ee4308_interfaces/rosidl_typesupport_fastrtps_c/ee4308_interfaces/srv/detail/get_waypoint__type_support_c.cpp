...
#include "ee4308_interfaces/srv/detail/get_waypoint__rosidl_typesupport_fastrtps_c.h"
...
using _GetWaypoint_Request__ros_msg_type = ee4308_interfaces__srv__GetWaypoint_Request;
...
size_t get_serialized_size_ee4308_interfaces__srv__GetWaypoint_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetWaypoint_Request__ros_msg_type * ros_message = static_cast<const _GetWaypoint_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _GetWaypoint_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ee4308_interfaces__srv__GetWaypoint_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ee4308_interfaces
size_t max_serialized_size_ee4308_interfaces__srv__GetWaypoint_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ee4308_interfaces__srv__GetWaypoint_Request;
    is_plain =
      (
...
static size_t _GetWaypoint_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ee4308_interfaces__srv__GetWaypoint_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ee4308_interfaces, srv, GetWaypoint_Request)() {
...
#include "geometry_msgs/msg/detail/point_stamped__functions.h"  // waypoint
...
using _GetWaypoint_Response__ros_msg_type = ee4308_interfaces__srv__GetWaypoint_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ee4308_interfaces
size_t get_serialized_size_ee4308_interfaces__srv__GetWaypoint_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetWaypoint_Response__ros_msg_type * ros_message = static_cast<const _GetWaypoint_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ee4308_interfaces__srv__GetWaypoint_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ee4308_interfaces
size_t max_serialized_size_ee4308_interfaces__srv__GetWaypoint_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ee4308_interfaces__srv__GetWaypoint_Response;
    is_plain =
      (
...
static size_t _GetWaypoint_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ee4308_interfaces__srv__GetWaypoint_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ee4308_interfaces, srv, GetWaypoint_Response)() {
...
// already included above
// #include "ee4308_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "ee4308_interfaces/srv/get_waypoint.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ee4308_interfaces, srv, GetWaypoint)() {
