...
static const _GetWaypoint_Request_type_support_symbol_names_t _GetWaypoint_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ee4308_interfaces, srv, GetWaypoint_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ee4308_interfaces, srv, GetWaypoint_Request)),
  }
};
...
{
  return &::ee4308_interfaces::srv::rosidl_typesupport_cpp::GetWaypoint_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ee4308_interfaces, srv, GetWaypoint_Request)() {
  return get_message_type_support_handle<ee4308_interfaces::srv::GetWaypoint_Request>();
}
...
static const _GetWaypoint_Response_type_support_symbol_names_t _GetWaypoint_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ee4308_interfaces, srv, GetWaypoint_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ee4308_interfaces, srv, GetWaypoint_Response)),
  }
};
...
{
  return &::ee4308_interfaces::srv::rosidl_typesupport_cpp::GetWaypoint_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ee4308_interfaces, srv, GetWaypoint_Response)() {
  return get_message_type_support_handle<ee4308_interfaces::srv::GetWaypoint_Response>();
}
...
static const _GetWaypoint_type_support_symbol_names_t _GetWaypoint_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ee4308_interfaces, srv, GetWaypoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ee4308_interfaces, srv, GetWaypoint)),
  }
};
...
{
  return &::ee4308_interfaces::srv::rosidl_typesupport_cpp::GetWaypoint_service_type_support_handle;
}
