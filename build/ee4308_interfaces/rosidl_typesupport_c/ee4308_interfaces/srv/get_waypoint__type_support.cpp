...
static const _GetWaypoint_Request_type_support_symbol_names_t _GetWaypoint_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ee4308_interfaces, srv, GetWaypoint_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ee4308_interfaces, srv, GetWaypoint_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ee4308_interfaces, srv, GetWaypoint_Request)() {
  return &::ee4308_interfaces::srv::rosidl_typesupport_c::GetWaypoint_Request_message_type_support_handle;
}
...
static const _GetWaypoint_Response_type_support_symbol_names_t _GetWaypoint_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ee4308_interfaces, srv, GetWaypoint_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ee4308_interfaces, srv, GetWaypoint_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ee4308_interfaces, srv, GetWaypoint_Response)() {
  return &::ee4308_interfaces::srv::rosidl_typesupport_c::GetWaypoint_Response_message_type_support_handle;
}
...
static const _GetWaypoint_type_support_symbol_names_t _GetWaypoint_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ee4308_interfaces, srv, GetWaypoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ee4308_interfaces, srv, GetWaypoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ee4308_interfaces, srv, GetWaypoint)() {
  return &::ee4308_interfaces::srv::rosidl_typesupport_c::GetWaypoint_service_type_support_handle;
}
